...
<header style="">
	...
	<div class="forms" style="margin-top:;">
			<h1  for="usr" style="cursor:default;">Sign Up</h1>
			<div class="form-content">
		<form action="" method="POST">
			<ul class="uls" style="list-style:none;">
				<li>
					<label style="float:left;" for="usr">Gmail :</label><input id="gmail" type="text" name="gmail" placeholder="Gmail.." style="padding:2px;" required>
				</li>
				<li>
				...
				<li>
					<input type="submit" name="signup" value="Kirim" class="bttn-send" style="	padding:2px; margin-top:10px; " >
				</li>
			</ul>
		</form>
		</div>
		...
		$pass = $_POST['password'];
		 ...
		 $_SESSION['strings'] = 0;
		//	var_dump($str);
		$sql_login ="INSERT  INTO account ('gmail','username','password') VALUES ('$gmail','$user','$pass')";
		$sql_account ="INSERT  INTO user ('username','password') VALUES ('$user','$pass')";
		$query01 = mysqli_query($conn,$sql_login); if(!$sql_login){echo 'Login DATA Not Sended!';}
		$query02 = mysqli_query($conn,$sql_account); if(!$sql_account){echo 'Account DATA Not Sended!';}
